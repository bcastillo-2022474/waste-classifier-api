...
from core.app.waste_item.application.use_cases.get_objets_recycling_material import GetObjetsRecyclingMaterialUseCase
...
class TestGetObjetsRecyclingMaterialUseCase(unittest.TestCase):
    def setUp(self):
        # Crear un mock del repositorio
        self.mock_repository = MagicMock(spec=WasteItemRepository)
        self.use_case = GetObjetsRecyclingMaterialUseCase(self.mock_repository)
    ...
    def test_execute_returns_material_and_count(self):
        ...
        self.mock_repository.getMaterial.return_value = expected_item
    ...
    def test_execute_returns_default_when_material_not_found(self):
        # Configurar el mock para devolver None
        material_waste = "UnknownMaterial"
        self.mock_repository.getMaterial.return_value = None
        ...
        # Verificar que el resultado sea el valor predeterminado
        self.assertEqual(result, {"material": "unknown", "count": 0})
